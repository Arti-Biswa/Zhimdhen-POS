...
public class QRCodeController {
    ...
    @CrossOrigin(origins =  "http://192.168.1.115:4200") // ⚠️ For development only. Replace with specific IP for production.
    ...
    public ResponseEntity<byte[]> generateQRCode(@PathVariable String tableId) {
        try {
            ...
            String baseUrl = "http://192.168.1.115:4200/menu?table=";
